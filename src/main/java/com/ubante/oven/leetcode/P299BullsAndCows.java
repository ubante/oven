...
public class P299BullsAndCows {
  ...
  public static String getHint(String secret, String guess) {
    ...
    for (int i=0; i<secret.length(); i++) {
      if (secret.charAt(i) == (guess.charAt(i))) {
        ...
        aLeftOvers = aLeftOvers + secret.charAt(i);
        bLeftOvers = bLeftOvers + guess.charAt(i);
      }
  ...
  public static void main(String[] args) {
    String secret = "1807333";
    String guess = "7810333";

    System.out.printf("Secret: %s, guess: %s, hint: %s\n", secret, guess, P299BullsAndCows.getHint(secret, guess));
  }
